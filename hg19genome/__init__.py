...
try:
    data.get_data_file("hg19.2bit")
except FileExistsError:
    response = input("Would you like to download hg19.2bit (~800MB). [Yes/No]")

    if response.upper() == "YES":
        print("Downloading hg19.2bit...", flush=True)
        download_genome()
